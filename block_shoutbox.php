...
<?php 
  ...
  {
	 $text.='<textarea name="insertion_data"  id=insertion_data'.$this->instance->id.'  onkeyup="limiter('.$this->instance->id.');" onFocus="empty(this);"     class="textarea_box"> Type text here</textarea> ';
	$ff=$this->config->char_allow;
	if(!isset($ff))
	   {
		$text.="<span class=limits>Please set your configuration</span>";
		}
   ...
   if(has_capability('block/shoutbox:typemessage', $context))
    {
	$text.='<input name="submit" type="submit" value="Submit" id='.$this->instance->id.'  onclick="return add_value(this);">';
	}
